            ...
            <div className="container mx-auto px-4 py-3">
                <div className="flex flex-col sm:flex-row items-center justify-between gap-4">
                    ...
                    <div className="relative w-full sm:w-auto">
                        ...
                        {showLocations && (
                            <div className="absolute top-full left-0 right-0 mt-1 bg-blue-400/95 lg:bg-blue-400/80 rounded-xl border border-primary-foreground/10 shadow-xl z-50 overflow-hidden">
